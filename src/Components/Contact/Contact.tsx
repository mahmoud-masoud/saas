...
const Contact = () => {
  ...
  return (
    <section className='py-24 relative p-4'>
      ...
      <Wrapper className='bg-gradient-to-tr from-indigo-900 to-cyan-900 overflow-hidden'>
        <div className='flex bg-black/50 backdrop-blur-3xl p-8 '>
          <ContactForm />
          <ContactInfo />
        </div>
      </Wrapper>
        ...
        <div className='flex flex-col gap-6'>
          <div className={`flex flex-col gap-4 border-slate-400 `}>
            ...
            <input
              ...
              name='name'
              placeholder='name'
              className={`border-2 py-2 px-4 bg-transparent ${
          ...
          <div className={`flex flex-col gap-4 border-slate-400`}>
            ...
            <textarea
              ...
              className={`border-2 py-2 px-4 bg-transparent min-h-40 ${
          ...
          <button className='bg-gradient-to-tr from-indigo-500 to-cyan-500 py-3 px-6 text-lg font-bold'>
